...
//noinspection GoUnusedExportedFunction
func SortStable(src []uint32) (out []uint32) {
	out = Copy(src)
...
//noinspection GoUnusedExportedFunction
func SlicesEqual(in1, in2 []uint32) bool {
...
//noinspection GoUnusedExportedFunction
func AsOptions(src []uint32, ifEmpty string) string {
